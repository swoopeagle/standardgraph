...
StandardGraph gives Claude access to 162,000+ education standards across 310 curriculum systems — Mathematics, Science, ELA, Social Studies, Computer Science, Arts, and World Languages. Covers all 50 US states plus major international curricula (Canada, UK, Australia, Singapore, Japan, IB, Cambridge, and more).
...
2. Download the standards database (~1.9 GB)
...
- Confirm the database downloaded fully: `ls -lh ~/.standardgraph/` — the `.db` file should be ~1.9 GB
